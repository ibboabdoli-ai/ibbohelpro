...
const jobsList = require('../api/jobs/list.js');
const providerStatus = require('../api/providers/status.js');
const adminApproval = require('../api/admin/provider-approval.js');
const adminList = require('../api/admin/list-provider-applications.js');
...
const requiredFiles = [
  ...
  'api/admin/list-provider-applications.js'
];
...
assert.ok(providerFeed.includes('provider-stage3.js'), 'provider feed should load Stage 3 script');
